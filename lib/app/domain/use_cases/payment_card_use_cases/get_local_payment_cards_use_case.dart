...
class GetLocalPaymentCardsListUseCase extends UseCase<DataState<List<PaymentCard>>, dynamic> {
  final PaymentCardsRepository _cardsRepository;

  GetLocalPaymentCardsListUseCase(this._cardsRepository);

  @override
  Future<DataState<List<PaymentCard>>> call({required dynamic params}) async {
    return await _cardsRepository.getLocalPaymentCardList();
  }
}
